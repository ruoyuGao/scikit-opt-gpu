...
public:
    ParticalSwarmOptimization(std::function<T(Eigen::Vector<T, L>&)> func, T c1=2.5, T c2=0.5, T w=0.5, T tol=1e-5, int MaxIters=1500, T delta_t=1, int NumParticles=1e5);
    void run() override;
